...
-- Sucessor de add_community_member_by_email: aceita e-mail OU username, inclui
-- organizador nos papeis, usa a capability manage_members, e recusa readicionar quem
-- ja e membro ativo em vez de rebaixar o cargo em silencio.
...
-- ============================================================================
-- Posse da sessao por usuario, com expiracao medida pela atividade (ultimo
-- ponto registrado) e nunca pelo aparelho. Sessao recem-criada sem nenhum
-- point_event cai em control_claimed_at via coalesce -- nunca nulo.
-- ============================================================================
